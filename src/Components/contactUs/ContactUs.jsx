    ...
    <div className="container">
      ...
      <div className="container side ">
        ...
        <Lottie animationData={contact}   />
            ...
            <h5  >Simply leave your contact number and we will call you back.

</h5>
<div  style={{margin:"20px 0"}}>
  
  <button className=" btn" style={{width:"100%" , padding:"7px" , borderRadius:"10px", }}><Link to={"https://api.whatsapp.com/send?phone=201011815928"} style={{textDecoration:"none" , color:"#fff"}}> Contact us on WhatsApp
 </Link>
  
  </button> <br />
  <button className="btn" style={{width:"100%" , padding:"7px" , borderRadius:"10px", marginTop:"10px" }} >
...
<div>
              ...
              >
                <button className="btn " style={{width:"100%" , padding:"7px" , borderRadius:"10px", marginTop:"10px" }}>Send</button>
              </div>
            </form>
          </div>
